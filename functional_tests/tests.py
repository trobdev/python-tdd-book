...
class NewVisitorTest(LiveServerTestCase):
	...
	def test_can_start_a_list_for_one_user(self):
		# Sam has heard about a cool new online to-do app...
	...
	def test_multiple_users_can_start_lists_at_different_urls(self):
		...
		#Francis visits the home page.  There is no sign of Sam's list
		self.browser.get(self.live_server_url)
		page_text = self.browser.find_element_by_tag_name('body').text
		self.assertNotIn('Buy peacock feathers', page_text)
		self.assertNotIn('make a fly', page_text)

		#Francis starts a new list by entering a new item, he is less interesting than Sam
		inputbox = self.browser.find_element_by_id('id_new_item')
		...
		self.assertNotEqual(francis_list_url, sam_list_url)

		#Again, there is no trace of Sam's list
		page_text = self.browser.find_element_by_tag_name('body').text
		self.assertNotIn('Buy peacock feathers', page_text)
